...
{
    /**
     * @Route(path="/inscriptionPro", name="inscriptionPro")
     */
    ...
    /**
     * @Route(path="/profilPro", name="profilPro")
     */
    ...
    /**
     * @Route(path="/connexionPro", name="connexionPro")
     */
...
//dd($user->getUsername());
    ...
    /**
     * @Route(path="/addProduct", name="addProduct")
     */
